...
int main () {
	//Initialize studID and numLet
  	...
  	double eval3 = (double) studID / numLet; // value of question 3
  	...
  	double eval5 = 100000.0 / (99 + eval5InParenth); // value of question 5 
  	// print out values
...
Expression #1 ----------: 1
Expression #2 ----------: 1
Expression #3 ----------: 3.36807e+06
Expression #4 ----------: 21
Expression #5 ----------: 6.38978
